...
const renderQuizzItem = ({ item }: any) => (
  <View style={gridStyle.gridItem}>
    <ImageBackground source={{ uri: item.image }} style={gridStyle.image}>
      {/* Gradient overlay */}
      <LinearGradient
      ...
      <View style={gridStyle.textContainer}>
        <Text style={gridStyle.itemText}>{item.title}</Text>
        <Text
  ...
  return (
    <ParallaxScrollView
      ...
      headerImage={
        <Image
          source={{
            uri: "https://img.freepik.com/free-vector/glitch-game-background_52683-3856.jpg?ga=GA1.1.563629714.1713778942&semt=ais_hybrid",
          }}
